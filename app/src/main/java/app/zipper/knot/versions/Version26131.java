...
public class Version26131 {
  public static LineVersion.Config create() {
    ...
    v.main.headerButtonTypeClass = "y98.d";
    ...
    v.settings.settingsHeaderItemClass = "i35.s";
    ...
    v.plusMenu.plusMenuComponentClass = "x01.k";
    v.plusMenu.plusMenuComposerImplClass = "h3.c1";
    v.plusMenu.plusMenuCallbackClass = "hh8.a";
    v.plusMenu.plusMenuOnClickItemClass = "hh8.l";
    ...
    v.chatListMoreMenu.clickListenerClass = "pw1.a";
    v.chatListMoreMenu.methodAddItem = "a";

    v.readReceipt.readReceiptManagerClass = "s83.e";
    ...
    v.unsend.chatMessageViewHolderClass = "rk1.g";
    v.unsend.methodReadBuffer = "b";
    v.unsend.methodBind = "a0";
    ...
    v.unsend.chatServiceConfigClass = "c25.t";
    v.unsend.methodUnsendLimit = "j";
    v.unsend.methodUnsendPremiumLimit = "i";
    v.unsend.appInfoProviderClass = "sd8.d";
    ...
    v.unsend.unsendDestroyHandlerClass = "qe8.a1";
    v.unsend.destroyMessageHandlerClass = "qe8.r";
    v.unsend.methodDestroyHandler = "b";
    v.unsend.messageConverterClass = "s88.r2";
    ...
    v.unsend.incomingMessageTypeEnumClass = "oc8.i$b";
    v.unsend.handlerSuccessResultClass = "pe8.a$a$c";
    ...
    v.home.home26LoadingMoreDataClass = "ea2.i$a";
    v.home.home26ModuleBodyField = "e";

    v.chat.headerController = "ff1.q1";
    ...
    v.chatHeader.fieldChatConfigChatId = "na1.a";
    v.chatHeader.fieldChatConfigIsMuted = "la1.a";
    v.chatHeader.fieldChatConfigType = "ff1.c1";
    v.chatHeader.fieldAppInfoVersion = "hq1.o";
    v.chatHeader.fieldAppInfoPkg = "p61.a";
    v.chatHeader.fieldAppInfoId = "xq0.d";

    v.font.fontConfigClass = "f7.m";
    v.font.fontManagerClass = "f7.l";
    v.font.fontCallbackClass = "f7.m$c";
    v.font.fontInjectedClass = "oo4.k";
    ...
    v.notificationFix.lineFcmServiceBaseClass = "du.i";
    v.notificationFix.firebaseRemoteMessageClass = "du.r0";
    ...
    v.notificationFix.firebaseDispatcherClass = "du.n";
    ...
    v.notificationFix.firebaseBindDeliveryClass = "du.m1";
    ...
    v.notificationFix.firebaseWakefulStartClass = "du.h1";
    ...
    v.notificationFix.firebaseAppClass = "ps.e";
    ...
    v.notificationFix.legyStreamingLifecycleMethod = "c1";
    ...
    v.notificationFix.legyDisconnectRunnableClass = "t50.k";
    ...
    v.talkTabHeader.chatTabHeaderStateClass = "jy1.e";
    v.talkTabHeader.iconListStateField = "y";
    v.talkTabHeader.buttonListStateField = "D";
    v.talkTabHeader.iconTypeClass = "v01.n";
    v.talkTabHeader.iconTypeFieldInButton = "a";
    v.talkTabHeader.subDeviceOpenChatButtonClass = "pw1.c$f";
    v.talkTabHeader.subDeviceAlbumButtonClass = "pw1.c$b";

    v.searchBarAgentI.talkVisibleMethod = "x";
    v.searchBarAgentI.talkClickMethod = "t";
    v.searchBarAgentI.homeSearchBarClass = "i05.i";
    ...
    v.searchBarAgentI.commerceHeaderClass = "az1.z";
    v.searchBarAgentI.commerceHeaderMethod = "e";
    v.searchBarAgentI.imageViewerAiButtonClass = "e08.f1";
    v.home26NavIcon.rendererClass = "ue2.n";
    ...
    v.compose.clickableClass = "u1.n0";
    ...
    v.imageQuality.qualityProfileHighClass = "fe8.a$b$a";
    v.imageQuality.qualityProfileMediumClass = "fe8.a$b$b";
    ...
    v.profile.g50fClass = "r70.g";
    v.profile.h13baClass = "bh3.b";
    v.profile.fieldH3 = "y0";
    v.profile.g50aClass = "r70.a";
    ...
    v.media.videoDurationCheckClass = "ba1.b";
    ...
    v.media.droppedMediaPreprocessorClass = "nx0.b";
    v.media.videoDurationSuccessClass = "ca1.a$c";
    v.media.fieldVideoDurationSuccess = "a";
    v.media.galleryViewClass = "oj1.z";
    v.media.fieldGalleryDurationLimit = "Y";
    v.media.selectionValidatorClass = "xa3.p";
    v.media.selectionValidatorMethod = "o";
    v.media.selectionValidatorParamClass = "b02.c";
    ...
    v.chat.searchPresenterClass = "vr1.n";
    v.chat.searchKeywordTypeClass = "q41.c";
    v.chat.searchKeywordTypeMethod = "d";
    v.chat.searchResultClass = "q41.h";
    ...
    v.chatTimestamp.displayTimeInterface = "r81.f";
    v.chatTimestamp.methodCreatedMillis = "a";

    v.chatEditSelectAll.selectionProviderClass = "j81.c";
    v.chatEditSelectAll.selectionStateClass = "j81.d";
    v.chatEditSelectAll.methodGetSelectionState = "e0";
    v.chatEditSelectAll.methodGetItem = "i0";
    v.chatEditSelectAll.methodGetSelectedIds = "d";
    v.chatEditSelectAll.methodToggleItem = "i";
    v.chatEditSelectAll.methodIsItemSelected = "m";

    v.messageEditHistory.editRequestClass = "u88.h";
    v.messageEditHistory.editRequestIdField = "b";
    v.messageEditHistory.editRequestTextField = "d";
    v.messageEditHistory.menuListBuilderClass = "og1.x1";
    v.messageEditHistory.menuListMethod = "a";
    v.messageEditHistory.menuItemEnumClass = "h71.c";
    v.messageEditHistory.menuPresentationEnumClass = "og1.a1";
    ...
    v.messageEditHistory.menuActionLambdaClass = "g71.f$b";
    ...
    v.camera.cameraModuleClass = "c72.j";
    ...
    v.camera.captureChooserClass = "os0.d0";
    ...
    v.callTone.toneSourceClass = "vy.g";
    v.callTone.uriToneSourceClass = "vy.b";
    v.callTone.methodToneUri = "a";
    v.callTone.remoteRingbackClass = "zj7.b";
    v.callTone.remoteRingbackContextField = "b";
    v.callTone.remoteRingbackFallbackField = "d";
    v.callTone.ringtoneWrapperClass = "zj7.c";

    v.muteMessage.labFeatureClass = "p58.d";
    v.muteMessage.methodIsFeatureEnabled = "c";
    v.muteMessage.silentMessageFeatureClass = "p58.v";
    v.muteMessage.sendModeClass = "rn1.d";
    v.muteMessage.methodSendMode = "a";
    v.muteMessage.sendModeEnumClass = "wt1.a";
    v.muteMessage.silentFlagWriterClass = "pe8.e1";
    ...
    v.homeTab.tabListProviderClass = "i48.e";
    ...
    v.nightMode.darkThemeManagerClass = "m76.k";
    v.nightMode.methodIsDarkTheme = "k";
